...
ALTER DATABASE vtnet_document_management CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Create database schema if not exists
CREATE DATABASE IF NOT EXISTS vtnet_document_management;

-- Use the database
USE vtnet_document_management;

-- Grant privileges to the application user
GRANT ALL PRIVILEGES ON vtnet_document_management.* TO 'vtnet'@'%';
FLUSH PRIVILEGES;

-- Create initial tables if they don't exist (these should be managed by Flyway in the application)
-- This is just a fallback in case the application's migrations fail
